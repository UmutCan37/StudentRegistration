    ...
    : IStudentRegistrationDbSchemaMigrator, ITransientDependency
{
    ...
    public EntityFrameworkCoreStudentRegistrationDbSchemaMigrator(IServiceProvider serviceProvider)
    {
    ...
    {
        /* We intentionally resolving the StudentRegistrationDbContext
