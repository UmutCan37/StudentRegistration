...
public class StudentRegistrationDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        StudentRegistrationGlobalFeatureConfigurator.Configure();
        StudentRegistrationModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<StudentRegistrationDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<StudentRegistrationResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/StudentRegistration");

            options.DefaultResourceType = typeof(StudentRegistrationResource);
        ...
        {
            options.MapCodeNamespace("StudentRegistration", typeof(StudentRegistrationResource));
        });
    }
}
